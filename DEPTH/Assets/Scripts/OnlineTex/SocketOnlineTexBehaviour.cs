...
public class SocketOnlineTexBehaviour : MonoBehaviour
{
    ...
    private void OnMessage(object sender, MessageEventArgs e)
    {
        ...
        //StartCoroutine(LoadTextureFromBase64(message));
    }
    ...
    public void Update()
    {
        ...
        {
            //Debug.Log($"Queue is empty" + ex.ToSafeString());
        }
